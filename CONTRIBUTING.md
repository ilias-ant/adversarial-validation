# Contributing to adversarial-validation
...
- When you are opening an issue, no need to improvise! Just [click here](https://github.com/ilias-ant/adversarial-validation/issues/new/choose) to create a new issue and select the ":bug: Bug Report" template.
...
Please provide as much detail and context as possible. Sounds boring? Just [click here](https://github.com/ilias-ant/adversarial-validation/issues/new/choose) to create a new issue and select the "🚀 Feature Request" template.
...
please first discuss the change you wish to make with the owners of this repository, by creating an [issue](https://github.com/ilias-ant/adversarial-validation/issues/new/choose).
...
```
[feat]: added verbose parameter on validate method

informative messages are printed to standard output in case verbose is set to 'true'
